...
function liveColorGlowOpacity(clock) {
  ...
  return [
    ...
    ['case',
      ['==', ['get', 'markerType'], MARKER_TYPES.sponsored],
      ['interpolate', ['linear'], ['get', 'viewersNumber'], 0, 0.18, 300, 0.24, 800, 0.35, 1500, 0.44],
      ['==', ['get', 'markerType'], MARKER_TYPES.vuvio],
      ['interpolate', ['linear'], ['get', 'viewersNumber'], 0, 0.20, 300, 0.26, 800, 0.38, 1500, 0.48],
      ['interpolate', ['linear'], ['get', 'viewersNumber'], 0, 0.16, 300, 0.20, 800, 0.32, 1500, 0.40],
    ],
    ['*', wave, ['case',
      ['==', ['get', 'markerType'], MARKER_TYPES.sponsored],
      ['interpolate', ['linear'], ['get', 'viewersNumber'], 0, 0.14, 800, 0.32, 1500, 0.42],
      ['==', ['get', 'markerType'], MARKER_TYPES.vuvio],
      ['interpolate', ['linear'], ['get', 'viewersNumber'], 0, 0.18, 800, 0.36, 1500, 0.46],
      ['interpolate', ['linear'], ['get', 'viewersNumber'], 0, 0.14, 800, 0.32, 1500, 0.42],
    ]],
  ];
}
