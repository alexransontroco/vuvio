...
export async function getProductHandler(req, res, productId) {
    try {
...
export async function importProductHandler(req, res) {
    try {
        await authenticateUser(req);
        const { providerId, externalId, category } = req.body;
