...
export async function endStream(req, res, streamId, backendReason) {
    ...
    await db.runTransaction(async (tx) => {
        ...
        if (user && stream.creatorId !== user.uid)
            throw new ApiError('forbidden', 'Only the creator can end this stream');
